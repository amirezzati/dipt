...
from rise_utils import get_optim_and_scheduler  , do_training_plip_res_kd

import argparse


def train_all_kd(epochs, train_doms, batch_size,
                   clip, clip_processor,
                   classnames, 
                   distill_weight, classification_weight,
