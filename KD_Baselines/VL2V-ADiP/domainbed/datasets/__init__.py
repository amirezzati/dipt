...
def get_dataset(test_envs, args, hparams, algorithm_class=None, open_target=None):
    """Get dataset and split."""
# is_mnist = "MNIST" in args.dataset
#     if open_target is not None:
#         dataset = vars(datasets)[args.dataset](args.data_dir, open_target)
#         dataset_tgt = vars(datasets)[args.dataset + "OST"](args.data_dir, open_target)
        
#         in_splits = []
#         out_splits = []
#         for env_i, (env, env_tgt) in enumerate(zip(dataset, dataset_tgt)):
