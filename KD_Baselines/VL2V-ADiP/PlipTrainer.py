...
root_data_dir = args['data_dir'] + '/camelyon17dc'
...
# train_doms = [["0", "2", "3"], ["0", "2", "4"], ["0", "3", "4"], ["2", "3", "4"]]
# val_doms = ["4", "3", "2", "0"]
# test_dom = ["1"]
...
# domain 0 as test_dom and val = 1 
train_doms = [["2", "3", "4"]]
val_doms = ["1"]
test_dom = ["0"]
...
args['name'] = "PLIP-VL2V-ADiP_ViT_t0"
args['backbone'] = "ViT-B/16"    # "ViT-L/14" "vit-B/16"
args['model'] = "vit-base"


# args['name'] = "PLIP-VL2V-ADiP_RN_t0"
# args['backbone'] = "RN50"    #\ resnet 50
# args['model'] = "resnet50"

# args['name'] = "PLIP-VL2V-ADiP_Prompt_RN_t0_v1"
# args['backbone'] = "RN50"    #\ resnet 50
# args['model'] = "resnet50"
