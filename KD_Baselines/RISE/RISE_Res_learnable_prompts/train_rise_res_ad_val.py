...
from load_prompts import get_learned_prompts_val1
...
def train_all_rise(epochs, train_doms, batch_size,
    ...
    for train_domains in train_doms:
        ...
        mean_prompts = get_learned_prompts_val1(classnames, clip, clip_processor, 4, train_domains, device)
            
        # Initialize student model

        
        student = create_model("resnetv2_50x1_bit.goog_in21k_ft_in1k", pretrained=True, num_classes=2)
        
        student.fc.weight.datadata = mean_prompts.clone()
        student.to(device)
        ...
        do_training_plip_res_AD(
            ...
            text_features_ems=mean_prompts,
