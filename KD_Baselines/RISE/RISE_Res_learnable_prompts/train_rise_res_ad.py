...
from load_prompts import get_learned_prompts_kather
...
def train_all_rise(epochs, train_doms, batch_size,
    ...
    for train_domains in train_doms:
        ...
        # val_domains = list(all_domains - train_set)
        val_domains = ['5']
        ...
        mean_prompts = get_learned_prompts_kather(classnames, clip, clip_processor, 4, train_domains, device)
